public class Main {
    public static void main(String[] args) {
        ...
        // 3.
        // 민수는 집 근처 시장이 4일장(매 4의 배수인 날마다 장날)인 점을 고려하여, 오늘 날짜를 입력하면 오늘이 장날인지 아닌지를 출력해주는
        // 코드를 작성하려고 합니다. if문과 연산자를 사용하여 today 변수에 오늘 일자를 입력했을 때 오늘이 장날이면 ‘장날!’ 그렇지 않으면
        ...
        // 4.
        // 민수는 현재 가지고 있는 용돈을 바탕으로 민수가 만들 수 있는 저녁메뉴를 출력해주는 코드를 작성하려고 합니다. if문과 논리연산자를
        // 사용하여 budget 변수에 민수가 가진 용돈을 입력했을 때, 아래 메뉴 정보에 따라 민수가 가진 용돈으로 만들 수 있는 메뉴가 모두
        // 출력되도록 코드를 완성하세요.(단, 메뉴는 한 번에 한 가지만 만들 수 있습니다. 만들 수 있는 메뉴가 없을 경우에는 ‘만들 수 있는
        // 메뉴가 없음.’ 이라는 문구가 출력되도록 하세요.)
        // 풀이:
        // int budget = 0;
