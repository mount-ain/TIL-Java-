public class Main {
    public static void main(String[] args) {
        ...
        // "가지" * 2 와 같은 코드를 사용하는 것이 허용되지 않는다는 것이빈다. 따라서 결과값은 error 발생
        ...
        // 풀이: 2번째 줄 Int b = 1, int c = 3; 에서 콤마 사용이 잘못되었습니다. 자바에서는 실행되는 코드들 사이 세미콜론을 입력하여
        // 코드를 구분합니다. 즉, b라는 변수를 생성한 후에 새로이 c라는 변수를 생성하기 위해서는 콤마가 아닌 세미콜론을 입력해주어야합니다.
        // 추가로, 데이터 타입과 할당하는 값이 동일할 경우, 3번째 줄의 int d,e = 4; 와 같이 동시에 여러 변수에 값을 할당할 수 있습니다.
        ...
        // double c = a + b;
        // System.out.println(c);
        // 풀이: 4.	A에 할당되는 값은 10F 즉 float 타입의 10.0 이며 a에 지정할 수 있는 데이터 타입은 float 과 double로 좁혀집니다.
